...
inline void VerificationOptions::AddTrustedCertificate(const UChar* in_certificate_buf, size_t in_buf_size)
{
	REX(TRN_VerificationOptionsAddTrustedCertificate(m_impl, in_certificate_buf, in_buf_size));
}

inline void VerificationOptions::AddTrustedCertificate(const UString& in_filepath)
{
	REX(TRN_VerificationOptionsAddTrustedCertificateUString((TRN_VerificationOptions)m_impl, (TRN_UString)in_filepath.mp_impl));
}
